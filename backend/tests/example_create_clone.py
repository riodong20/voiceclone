...
# 公网可访问音频URL
AUDIO_URL = (
    "http://tcafk9npq.hd-bkt.clouddn.com/"
    "0841505e-e09e-4afb-8df0-60c4d5c8bbb7.mp3?"
    "e=1774161913&token=_bvmGYH-r6Q4zotTM5YHlZ-2FUSOtadbXYjBO092:WZCrDIOuBD1myIccDV_wZoz7s4A="
)  # 示例URL，请替换为自己的
...
try:
    voice_id = service.create_voice(target_model=TARGET_MODEL, prefix=VOICE_PREFIX, url=AUDIO_URL)
